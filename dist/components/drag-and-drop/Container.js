...
const Container = _ref => {
  ...
  const moveBox = (0, _react.useCallback)((id, left, top) => {
    setBoxes((0, _immutabilityHelper.default)(boxes, {
      [id]: {
        $merge: {
          left,
          top
  ...
  }, boxes.map((key, index) => /*#__PURE__*/_react.default.createElement(_DraggableBox.DraggableBox, _extends({
    key: index,
    id: index
  }, key, {
    boxes: boxes,
